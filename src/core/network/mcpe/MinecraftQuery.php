...
class MinecraftQuery {
    ...
    private function getStatus($challenge) : array {
    ...
    private function writeData($command, string $append = "") : string | bool {
        $command = MinecraftQuery . phpPack("c*", 0xFE, 0xFD, $command, 0x01, 0x02, 0x03, 0x04);
